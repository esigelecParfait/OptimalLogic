# Actifs et décisions de direction artistique

Statut : `ready_for_review`

## Disponibles

- logo actuel et favicon ;
- Inter Variable et Space Grotesk Variable ;
- palette noire, blanche et verte codée sur `main` ;
- contenus et libellés structurés dans `04-content/` ;
- quatre rasters historiques conservés uniquement pour la traçabilité.

## À construire en code

- convergence de signaux du héros ;
- flux « présence → demande → qualification → transmission → décision humaine » ;
...
Tous ces actifs possèdent un état statique complet, une variante mobile et un contrat accessible dans `06-assets/`.
...
Aucune photo d’équipe, étude de cas, statistique, marque cliente ou témoignage autorisé. La composition finale ne réserve aucun emplacement factice en leur attente.
