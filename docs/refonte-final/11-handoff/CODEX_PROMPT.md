...
2. Les décisions O-002 et O-003 sont closes ou assorties d'une règle validée.
3. La correspondance validée des trois présentations avec les codes BDD est conservée sans modification du backend.
