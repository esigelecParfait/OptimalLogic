# Principes visuels transposables

Statut : `ready_for_review`

1. Un premier écran doit présenter une promesse, une action et une composition structurelle, sans statistiques de remplissage.
2. Alterner des chapitres sombres opérationnels et des respirations ivoire éditoriales.
...
10. Une animation explique une progression ou un état ; elle ne constitue jamais la preuve du produit.
11. Le rendu statique doit déjà être premium, complet et compréhensible avant hydratation ou lorsque le mouvement est réduit.
