...
| Présence et empreintes des images | Pass | Dimensions et SHA-256 |

## Bloquants avant Codex

1. Validation explicite du brief, des contenus, de la direction et des médias.
2. Validation des inclusions exactes des deux offres TPE/PME et Startup.
3. Validation de Lora, de la surface ivoire et de l'accent bleu Startup.
...
Le code final n'existe pas encore. Build, Playwright, responsive, accessibilité, Lighthouse, intégrations réelles et RLS sont donc `not_tested`, jamais considérés comme réussis.
