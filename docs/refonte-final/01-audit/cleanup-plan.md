...
1. Sauvegarder et approuver `docs/refonte-final/` sur `champion`.
...
3. Réappliquer le dossier final approuvé et construire les actifs code-native déclarés, sans reprendre les rasters historiques.
4. Retirer les anciens actifs V2, previews, comparateur, showroom et skills locales rejetées.
