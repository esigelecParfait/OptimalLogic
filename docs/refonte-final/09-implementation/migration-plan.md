...
Ne pas réintroduire l'ancien dossier V2, les quatre rasters historiques supprimés, les anciens médias, previews, comparateur, showroom ou composants génériques inutilisés. Chaque lot doit être un commit autonome et récupérable ; aucune migration destructive ni modification backend n'est autorisée.
