...
| `blocks/index.ts`   | Point d'entrée public de la bibliothèque        | Les 45 variantes et leurs types de contenu                             |
...
## Inventaire initial et extension premium

Le tableau ci-dessous conserve l'inventaire des 22 variantes initiales. Les 23
variantes ajoutées à l'étape 4 portent le total à 45 et sont documentées dans
`docs/PUBLIC-COMPOSITIONS.md`.
