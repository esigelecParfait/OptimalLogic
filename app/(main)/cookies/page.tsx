    ...
    <main className="relative">
      <section className="px-7 pb-12 pt-44 lg:pt-52">
        <div className="mx-auto max-w-[1240px]">
          <div
            className="inline-flex items-center gap-2 rounded-full border border-white/[0.13] px-4 py-2 text-sm font-medium text-ink"
            style={{ background: "var(--grad-soft)" }}
          >
            Cookies &amp; traceurs
          </div>
          <h1 className="mt-6 max-w-4xl text-[clamp(38px,5.4vw,68px)] font-semibold">
            Gestion des cookies.
            <span className="grad-text"> Choisissez ce que vous acceptez.</span>
          </h1>
          <p className="mt-8 max-w-3xl text-lg leading-8 text-mut">
            Cette page explique les cookies et traceurs qui peuvent être utilisés sur le
            site. Vous pouvez modifier vos préférences à tout moment.
          </p>
          <button
            type="button"
            onClick={openCookiePreferences}
            className="btn-grad mt-10 inline-flex rounded-full px-6 py-3 text-sm font-semibold"
          >
      ...
      <section className="px-7 py-10">
        <div
          className="mx-auto max-w-[1240px] rounded-[28px] border border-white/[0.13] p-8 sm:p-10 lg:p-12"
          style={{
            background:
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            ...
            <p className="text-sm leading-7 text-mut">
              Les cookies nécessaires permettent au site de fonctionner. Les cookies
              d’audience, marketing ou certains outils tiers peuvent être activés
      ...
      <section className="px-7 py-16">
        <div className="mx-auto max-w-[1240px]">
          <div className="mb-10 max-w-3xl">
            ...
            <h2 className="mt-4 text-[clamp(28px,3.6vw,44px)] font-semibold">
            ...
            {cookieTypes.map((type) => (
              <div key={type.title} className="surface-card rounded-[24px] p-6 sm:p-8">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <span
                    className="shrink-0 rounded-full border border-white/[0.1] px-3 py-1.5 text-xs font-semibold text-mut"
        ...
        <div className="mx-auto grid max-w-[1240px] gap-6 lg:grid-cols-2">
          <div className="surface-card rounded-[24px] p-6 sm:p-8">
            ...
            <ul className="mt-6 grid gap-3 text-sm leading-6 text-mut">
              ...
              <li>
                • Meta Pixel, TikTok Pixel ou outil publicitaire si installé plus tard
              </li>
          ...
          <div className="surface-card rounded-[24px] p-6 sm:p-8">
            ...
            <p className="mt-6 text-sm leading-7 text-mut">
              Vous pouvez accepter, refuser ou personnaliser vos choix. Vos préférences
              sont conservées localement dans votre navigateur afin d’éviter de vous
              redemander votre choix à chaque visite.
            </p>
            <button
              type="button"
              onClick={openCookiePreferences}
              className="btn-grad mt-8 inline-flex rounded-full px-6 py-3 text-sm font-semibold"
            >
              Modifier mes préférences
            </button>
          </div>
