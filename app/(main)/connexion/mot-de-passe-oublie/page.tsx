  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-5 py-32">
      <div className="surface-card w-full max-w-md rounded-[28px] p-8 shadow-[0_40px_90px_-40px_rgba(0,0,0,0.9)] sm:p-10">
        ...
        {state.success ? (
          <div className="mt-8 rounded-2xl border border-white/[0.07] p-6 text-sm leading-6 text-mut" style={{ background: "rgba(16,20,42,0.5)" }}>
        ...
        <div className="mt-6 text-center text-sm text-mut">
          <Link href="/connexion" className="font-semibold text-cyan underline-offset-4 hover:underline">Retour à la connexion</Link>
        </div>
      </div>
    </main>
  );
