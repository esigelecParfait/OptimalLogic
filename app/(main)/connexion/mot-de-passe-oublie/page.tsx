...
export default function MotDePasseOubliePage() {
  ...
  return (
    ...
    >
      {state.success ? (
        <div
          className="rounded-2xl border border-white/[0.09] p-6 text-sm leading-6 text-mut"
          style={{ background: "rgba(26,26,29,0.5)" }}
        >
          Si un compte existe avec cet e-mail, vous allez recevoir un lien pour définir un
