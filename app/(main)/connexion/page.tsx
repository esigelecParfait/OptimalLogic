  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-5 py-32">
      <div className="surface-card w-full max-w-md rounded-[28px] p-8 shadow-[0_40px_90px_-40px_rgba(0,0,0,0.9)] sm:p-10">
        ...
        <h1 className="mt-4 font-display text-3xl font-semibold">Connexion</h1>
        <p className="mt-3 text-sm leading-6 text-mut">Connectez-vous pour suivre l’avancement de votre service et contacter notre support.</p>
        ...
        <div className="mt-6 text-center text-sm text-mut">
          <Link href="/connexion/mot-de-passe-oublie" className="font-semibold text-white underline-offset-4 hover:underline">Mot de passe oublié ?</Link>
        </div>
      </div>
    </main>
  );
