                  ...
                  <td className="px-5 py-4">
                    {latest ? (
                      <div className="space-y-1.5">
                        <span
                          className={`inline-block rounded-full border px-2.5 py-1 text-[11px] font-medium ${statusColors[status ?? ""] ?? "text-mut border-white/10"}`}
                        >
                          {(status ?? "").replace(/_/g, " ")}
                        </span>
                    ...
                    <div className="flex flex-col gap-2">
                      {isClient ? (
                        ...
                        <span className="text-[11px] text-mut-2">
                          Aucune offre ({p.type_client ?? "type inconnu"})
                        </span>
                      )}
                      <Link
