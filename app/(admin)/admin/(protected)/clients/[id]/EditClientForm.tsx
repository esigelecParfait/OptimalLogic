  ...
  return (
    <form action={action} className="space-y-5">
        ...
        <div className="grid grid-cols-[90px_1fr] gap-2">
          <div>
            ...
            <input
              ...
              defaultValue={prospect.phone_country_code ?? "+33"}
              placeholder="+33"
              required
            />
          </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            className={field}
            name="type_client"
            defaultValue={prospect.type_client ?? ""}
          >
            <option value="">—</option>
            {typeOptions.map((o) => (
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            className={field}
            name="business_city"
            defaultValue={prospect.business_city ?? ""}
          />
        </div>
        <div>
          ...
          <input
            ...
            defaultValue={prospect.business_sector ?? ""}
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            defaultValue={prospect.business_website_url ?? ""}
            placeholder="https://…"
          />
        </div>
        <div>
      ...
      <div className="flex items-center gap-3 pt-2">
        ...
        {state.success && (
          <span className="text-sm font-medium text-emerald-400">✓ Enregistré</span>
        )}
